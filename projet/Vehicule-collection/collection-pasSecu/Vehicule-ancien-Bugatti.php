...
<body>
    ...
    <form action="Vehicule-ancien-Bugatti.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	 <form action="Vehicule-ancien-Bugatti.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND Type_de_Vehicule = 'Collection' AND Marque = 'Bugatti' AND Marque = 'bugatti'";
