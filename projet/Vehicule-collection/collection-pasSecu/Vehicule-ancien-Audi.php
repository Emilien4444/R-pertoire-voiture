...
<head>
  ...
  <link rel="stylesheet" href="../../CSS/Voitures.css">
    ...
    <form action="Vehicule-ancien-Audi.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	<form action="Vehicule-ancien-Audi.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
        ...
        AND Type_de_Vehicule = 'Collection' AND Marque = 'Audi' AND Marque = 'audi' ";
