...
<body>
    ...
    <form action="Vehicule-ancien-Cadillac.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
  
  	<form action="Vehicule-ancien-Cadillac.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
       ...
       $serveur = "we96pm.myd.infomaniak.com";
		...
		AND Type_de_Vehicule = 'Collection' AND Marque = 'Cadillac' AND Marque = 'cadillac'";
