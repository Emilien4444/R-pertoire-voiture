...
<body>
        ...
        <p><h1> Rolls Roys </h1></p>
        
        <?php include("menu-collection.php"); ?>
        <br>
        
    <form action="Vehicule-ancien-RollsRoyce.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	<form action="Vehicule-ancien-RollsRoyce.php" method="GET" class="sort-buttons-container">
