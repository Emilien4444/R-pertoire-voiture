...
<html>
<head>
    <title>Véhicules De collection </title>
    <meta charset="utf-8">
...
<body>
    <h1>Véhicules de Collection </h1>

    <nav> 
    <ul>
	  	<li><a href="../../accueil.php"> Accueil </a></li>
        <li><a href="Vehicule-ancien-AstonMartin.php">Aston Martin </a></li>
        <li><a href="Vehicule-ancien-Audi.php">Audi </a></li>
        <li><a href="Vehicule-ancien-Bentley.php">Bentley </a></li>
	  	<li><a href="Vehicule-ancien-BMW.php">BMW </a></li>
        <li><a href="Vehicule-ancien-Bugatti.php">Bugatti </a></li>
	  	<li><a href="Vehicule-ancien-Cadillac.php">Cadillac </a></li>
        <li><a href="Vehicule-ancien-Ferrari.php">Ferrari </a></li>
        <li><a href="Vehicule-ancien-Ford.php">Ford </a></li>
        <li><a href="Vehicule-ancien-Jaguard.php">Jaguard </a></li>
        <li><a href="Vehicule-ancien-Lamborghini.php">Lamborghini </a></li>
        <li><a href="Vehicule-ancien-Maserati.php">Maserati </a></li>
        <li><a href="Vehicule-ancien-Mercedes.php">Mercedes-Benz </a></li>
        <li><a href="Vehicule-ancien-Porsche.php">Porsche </a></li>
        <li> <a href="Vehicule-ancien-Renault.php">Renault </a></li>
        <li><a href="Vehicule-ancien-RollsRoyce.php">Rolls Royce </a></li>
    </ul>
	</nav>
    <br><br><br><br>

    <form action="vehicule-collection.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
  
  	<form action="Vehicule-collection.php" method="GET" class="sort-buttons-container">
