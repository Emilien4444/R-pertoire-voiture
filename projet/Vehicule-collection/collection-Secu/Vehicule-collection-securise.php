...
<html lang="fr-FR">
<head>
    <title>Véhicules Collection</title>
    <meta charset='utf-8'>
...
<body>
    ...
    <ul>
        ...
        <li><a href="ancien-AstonMartin-Secu.php">Aston Martin </a></li>
        <li> <a href="ancien-Audi-Secu.php">Audi </a></li>
        <li> <a href="ancien-Bentley-Secu.php">Bentley </a></li>
	  	<li> <a href="ancien-BMW-Secu.php">BMW </a></li>
        <li> <a href="ancien-Bugatti-Secu.php">Bugatti </a></li>
	  	<li> <a href="ancien-Cadillac-Secu.php">Cadillac </a></li>
        <li><a href="ancien-Ferrari-Secu.php">Ferrari </a></li>
        <li> <a href="ancien-Ford-Secu.php">Ford </a></li>
        <li> <a href="ancien-Jaguard-Secu.php">Jaguard </a></li>
        <li> <a href="ancien-Lamborghini-Secu.php">Lamborghini </a></li>
	  	<li> <a href="ancien-Lincoln-Secu.php">Lincoln </a></li>
        <li> <a href="ancien-Maserati-Secu.php">Maserati </a></li>
        <li><a href="ancien-Mercedes-Secu.php">Mercedes-Benz </a></li>
        <li><a href="ancien-Porsche-Secu.php">Porsche </a></li>
        <li> <a href="ancien-Renault-Secu.php">Renault </a></li>
        <li> <a href="ancien-RollsRoyce-Secu.php">Rolls Royce </a></li>
	  	<li> <a href="../../favoris.php">Vos favoris  </a></li>
    </ul>
	</nav>
    <br><br><br><br>

    <form action="Vehicule-collection-securise.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
  
  	<form action="Vehicule-collection-securise.php" method="GET" class="sort-buttons-container">
    ...
    if(isset($_SESSION['id'])) {
        ...
        // Si l'utilisateur n'est pas connecté, afficher un message
        	echo "<p>Veuillez vous connecter pour voir les véhicules de collection.</p>";
    	}
    ?>
</section>
...
<!-- Script JavaScript pour afficher une alerte quand la voiture est ajoutée -->
<script>
    // Vérifie si la page a été chargée avec un paramètre "success"
    const urlParams = new URLSearchParams(window.location.search);
    const chargement_reussi = urlParams.get('success');
    if (chargement_reussi === '1') {
        // Affiche une alerte indiquant que le véhicule a été ajouté avec succès
