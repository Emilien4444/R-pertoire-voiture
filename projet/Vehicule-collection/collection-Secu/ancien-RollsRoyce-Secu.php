...
<body>
    ...
    <form action="ancien-RollsRoyce-Secu.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	 <form action="ancien-RollsRoyce-Secu.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
    	...
    	if(isset($_SESSION['id'])) {
			...
			AND ( Marque = 'Rolls-Royce'  OR Marque = 'rolls-royce' OR Marque = 'Rolls-royce' OR Marque = 'rolls-Royce' OR Marque = 'rolls Royce' OR Marque = 'Rolls royce'  )
