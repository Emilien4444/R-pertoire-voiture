...
<body>
    ...
    <?php 
		...
		echo "<p><h1> Cadillac </h1></p>" ; 
	?>

     	<?php include("menu-collection-Secu.php"); ?>
        <br>
        
    <form action="ancien-Cadillac-Secu.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	 <form action="ancien-Cadillac-Secu.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND ( Marque = 'Cadillac'  OR Marque = 'cadillac')
