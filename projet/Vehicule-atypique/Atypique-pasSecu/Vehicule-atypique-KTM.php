...
<body>
  ...
  <?php include("menu-atypique.php"); ?>
    ...
    <form action="Vehicule-atypique-KTM.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	<form action="Vehicule-atypique-KTM.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND Type_de_Vehicule = 'Atypique' AND Marque = 'KTM'  AND Marque = 'ktm'";
