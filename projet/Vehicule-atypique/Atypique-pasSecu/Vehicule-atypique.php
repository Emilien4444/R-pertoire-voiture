...
<html>
    <head>
        <title> Vehicules Atypiques</title>
        <meta charset= 'utf-8'>
    ...
    <body>
    	...
    	<ul>
      		...
      		<li><a href="Vehicule-atypique-AstonMartin.php">Aston Martin </a></li>
	  		<li><a href="Vehicule-atypique-KTM.php"> KTM </a></li>
    	</ul>
		</nav>
    	<br><br><br><br>

    	<form action="Vehicule-atypique.php" method="GET">
        	<label for="search">Rechercher un véhicule :</label>
        	<input type="text" id="search" name="search">
        	<button type="submit">Rechercher</button>
    	</form>
	  
	   	<form action="Vehicule-atypique.php" method="GET" class="sort-buttons-container">
