...
<body>
	...
	<p><h1> Aston Martin </h1></p>
        
  	<?php include("menu-atypique.php"); ?>
   <br>
        
    <form action="Vehicule-atypique-AstonMartin.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	<form action="Vehicule-atypique-AstonMartin.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND Type_de_Vehicule = 'Atypique' AND Marque = 'Aston Martin'  AND Marque = 'aston martin'";
