...
<head>
  ...
  <link rel="stylesheet" href="../../CSS/Voitures.css">
    ...
    <form action="vehicule-atypique-KTM-securise.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	<form action="Vehicule-atypique-KTM-securise.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
        ...
        WHERE voitures.Valide = 1 AND voitures.Type_de_Vehicule = 'Atypique'  AND (Marque = 'KTM'  OR Marque = 'ktm')
