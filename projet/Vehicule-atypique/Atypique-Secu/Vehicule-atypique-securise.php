...
<html lang="fr-FR">
<head>
    <title>Véhicules Atypiques</title>
    <meta charset='utf-8'>
...
<nav> 
   <ul>
		<li><a href="../../accueil-securise.php"> Accueil </a></li>
	  	<li><a href="Vehicule-atypique-AstonMartin-securise.php">Aston Martin </a></li>
	  	<li><a href="Vehicule-atypique-KTM-securise.php"> KTM </a></li>
		<li><a href='../../favoris.php'>Vos favoris</a></li>;
    </ul>
</nav>
<br><br><br>

<form action="Vehicule-atypique-securise.php" method="GET">
    <label for="search">Rechercher un véhicule :</label>
    <input type="text" id="search" name="search">
    <button type="submit">Rechercher</button>
</form>

<form action="Vehicule-atypique-securise.php" method="GET" class="sort-buttons-container">
...
<section class="vehicule-container">
    ...
    if(isset($_SESSION['id'])) {
        ...
        WHERE voitures.Valide = 1 AND voitures.Type_de_Vehicule = 'Atypique'
        ...
        if ($result->num_rows > 0) {
            ...
            echo "Aucun résultat trouvé pour la recherche : '$searchTerm'dans la catégorie Atypique.";
        }
