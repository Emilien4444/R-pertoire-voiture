...
<head>
	...
	echo "<p><h1> Aston Martin </h1></p>" ;

	// Récupérer l'identifiant de l'utilisateur connecté
    $id_utilisateur = $_SESSION['id'];
	?>
        
	<?php include("menu-Atypique-secu.php"); ?>
	<br><br><br>
        
    <form action="Vehicule-atypique-AstonMartin-securise.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	<form action="Vehicule-atypique-AstonMartin-securise.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND ( Marque = 'Aston Martin'  OR Marque = 'aston martin')
