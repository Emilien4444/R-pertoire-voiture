...
<body>
        ...
        <?php include("menu-sportif-Secu.php"); ?>
        <br>
        
    <form action="sportifs-Audi-Secu.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	 <form action="sportifs-Audi-Secu.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND ( Marque = 'Audi'  OR Marque = 'audi')
        ...
        echo "<p>Veuillez vous connecter pour voir les véhicules sportifs.</p>";
    }
        ?>
    </section>
