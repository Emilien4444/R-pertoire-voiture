...
<body>
    ...
    <form action="sportifs-Bugatti-Secu.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	 <form action="sportifs-Bugatti-Secu.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND ( Marque = 'Bugatti'  OR Marque = 'bugatti')
