...
<body>
    ...
    <form action="sportifs-Ferrari-Secu.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	 <form action="sportifs-Ferrari-Secu.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND ( Marque = 'Ferrari'  OR Marque = 'ferrari')
        ...
        echo "<p>Veuillez vous connecter pour voir les véhicules spotifs.</p>";
    }
        ?>
    </section>
