...
<body>
		...
		echo "<p><h1> RollsRoyce </h1></p>" ; 
		?>
        
        <?php include("menu-sportif-Secu.php"); ?>
        <br>
        
    <form action="sportifs-RollsRoyce-Secu.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>

	 <form action="sportifs-RollsRoyce-Secu.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND ( Marque = 'Rolls-Royce'  OR Marque = 'rolls-royce' OR Marque = 'Rolls Royce' OR Marque = 'rolls royce' )
		...
		// Si un tri par prix est demandé
		if ($tri === 'prix_asc') {
