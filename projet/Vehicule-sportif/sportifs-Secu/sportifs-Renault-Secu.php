...
<body>
		...
		echo "<p><h1> Renault </h1></p>" ;
		?>
        
        <?php include("menu-sportif-Secu.php"); ?>
        <br>
        
    <form action="sportifs-Renault-Secu.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>

	 <form action="sportifs-Renault-Secu.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND ( Marque = 'Renault'  OR Marque = 'renault')
