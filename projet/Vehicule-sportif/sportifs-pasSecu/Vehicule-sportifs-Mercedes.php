<!DOCTYPE html>
    <html>
        ...
        <body>
        <p><h1> Mercedes-Benz </h1></p>
        
        <?php include("menu-sportif.php"); ?>
        <br>
            
    <form action="Vehicule-sportifs-Mercedes.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
		  
	<form action="Vehicule-sportifs-Mercedes.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND Marque = 'Mercedes-Benz' AND Marque = 'mercedes-benz'";
