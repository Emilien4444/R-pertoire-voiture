...
<body>
  		...
  		<p><h1> Alpha Roméo </h1></p>
        
        <?php include("menu-sportif.php"); ?>
        <br>
        
    <form action="Vehicule-sportifs-AlfaRomeo.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	 <form action="Vehicule-sportifs-AlfaRomeo.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND Type_de_Vehicule = 'sportive' AND Marque = 'Alfa Romeo' AND Marque = 'alfa romeo' ";
