...
<body>
        ...
        <p><h1> Rolls Royce </h1></p>
        
        <?php include("menu-sportif.php"); ?>
        <br>
        
    <form action="Vehicule-sportifs-RollsRoyce.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	<form action="Vehicule-sportifs-RollsRoyce.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND Marque = 'RollsRoce' AND Marque = 'Rolls Royce' AND Marque = 'rolls-royce' AND Marque = 'rolls royce'  ";
