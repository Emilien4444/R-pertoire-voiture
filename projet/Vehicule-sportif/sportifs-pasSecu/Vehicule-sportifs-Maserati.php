...
<html>
    ...
    <form action="Vehicule-sportifs-Maserati.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
	  
	 <form action="Vehicule-sportifs-Maserati.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		AND Type_de_Vehicule = 'sportive' AND Marque = 'Maserati' AND Marque = 'maserati' ";
