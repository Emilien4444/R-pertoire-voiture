...
<body>
    <p><h1> Lamborghini </h1></p>
        
    <?php include("menu-sportif.php"); ?>
    <br>
        
    <form action="Vehicule-sportifs-Lamborghini.php" method="GET">
        <label for="search">Rechercher un véhicule :</label>
        <input type="text" id="search" name="search">
        <button type="submit">Rechercher</button>
    </form>
  
  	<form action="Vehicule-sportifs-Lamborghini.php" method="GET" class="sort-buttons-container">
    ...
    <section class="vehicule-container">
		...
		(Marque LIKE '%$searchTerm%' OR Nom_du_model LIKE '%$searchTerm%')
		AND Type_de_Vehicule = 'sportive' AND Marque = 'Lamborghini' AND Marque = 'lamborghini' ";
