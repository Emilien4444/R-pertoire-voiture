<!DOCTYPE html>
    <html lang="fr-FR">
        ...
        <div class="compte-essaie">        
            ...
            <div class="demande-essai">
                <h2>Demande d'essai</h2>
                <form id="ddeEssaiForm" action="demande_essai.php" method="post">
                    <input type="text" id="nomEssai" name="nomEssai" placeholder="Nom" required>
                    <input type="email" id="emailEssai" name="emailEssai" placeholder="Email" required>
                    ...
                    <input type="date" id="dateEssai" name="dateEssai" required>
                    <input type="time" id="heureEssai" name="heureEssai" required>
                    <button type="submit">Demander un essai</button>
                </form>
                <p id="message"></p>
            </div>
        </div>
       ...
       <!-- Script JavaScript pour afficher le message de Connexion -->
		  <script> 
    		// Récupération des paramètres de l'URL
    		const urlParams = new URLSearchParams(window.location.search);
    
    		// Vérification si le paramètre 'deconnexion' est présent dans l'URL
    		const connexion = urlParams.get('connexion');
    		if (connexion === '1') {
